    ...
    <div className="w-full rounded-3xl bg-white/95 px-6 py-8 shadow-[0_8px_30px_rgba(0,0,0,0.25)]">
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="flex flex-col items-center gap-2 flex-1">
          ...
          <span className="text-xs font-bold text-blue-950">Donor</span>
        </div>
        ...
        <div className="flex flex-col items-center gap-2 flex-1">
          ...
          <span className="text-xs font-bold text-red-700">Blood</span>
        </div>
        ...
        <div className="flex flex-col items-center gap-2 flex-1">
          ...
          <span className="text-xs font-bold text-blue-950">Patient</span>
        </div>
      </div>
